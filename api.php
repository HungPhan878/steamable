...
// Định nghĩa API key 
$validApiKey = 'upload_video_toi_day_hoc';
define('API_KEY', $validApiKey);

//c1: dùng getallheaders
$headers = getallheaders();
if (!isset($headers['API_KEY']) || $headers['API_KEY'] !== API_KEY) {
    echo json_encode(['status' => 401, 'message' => 'Unauthorized: Invalid API Key']);
    exit();
}

// c2: Kiểm tra API key trong header của request 
